...
ModPE.langEdit("menu.generatingLevel", "Loading...");
ModPE.langEdit("menu.generatingTerrain", "Loading...");
ModPE.langEdit("menu.loadingLevel", "Loading...");
ModPE.langEdit("progressScreen.generating", "Loading...");
ModPE.langEdit("progressScreen.message.building", "Loading...");
ModPE.langEdit("progressScreen.message.locating", "Locating...");

		...
		init: function () {
					...
					if (tracers1) {
						try {
							...
							all.forEach(function (entry) {
								...
								if (dist <= 200 && dist > 0.1 && Entity.getEntityTypeId(entry) <= 63) Utils.Render.drawLine(gl, px, py + 0.8, pz, Entity.getX(entry), Entity.getY(entry) + 1, Entity.getZ(entry));
							});
			...
			ctx.runOnUiThread(new java.lang.Runnable({
				run: function () {
					...
					Utils.Render.glSurface.getHolder()
					...
					ctx.getWindow()
						.getDecorView()
						.addView(Utils.Render.glSurface);
	...
	Entity: {
		...
		getNearestEntity(maxrange, bypass) {
			...
			mobs.forEach(function (entry) {
				...
				if (Entity.getEntityTypeId(entry) == 63 && Entity.getNameTag(entry) == "") return;
				if (!(Utils.Entity.targettedMobs[1] == true && Entity.getEntityTypeId(entry) == 63) && !(Utils.Entity.targettedMobs[0] == true && Entity.getEntityTypeId(entry) < 63)) return;
			...
			players.forEach(function (entry) {
				...
				if (bypass && y > 0.8) {
					...
					if (xVel == 0 && yVel == 0 && zVel == 0) return;
				}
				if (Entity.getEntityTypeId(entry) == 63 && Entity.getNameTag(entry) == "") return;
				if (!(Utils.Entity.targettedMobs[1] == true && Entity.getEntityTypeId(entry) == 63) && !(Utils.Entity.targettedMobs[0] == true && Entity.getEntityTypeId(entry) < 63)) return;
				if (Entity.getHealth(entry) > 0 && Entity.getNameTag(entry) == "") {
				...
				button6.setOnClickListener(new android.view.View.OnClickListener({
					onClick: function (viewarg) {
						...
						if (glide == true) {
							...
							android.widget.Toast.makeText(MainActivity, "Credit: Apric0cks from maximus mod!", 1)
								.show();
							glide = true;
						}
						if (glide == false) {
				...
				spiderman.setOnClickListener(new android.view.View.OnClickListener({
					onClick: function (viewarg) {
						...
						if (spider == true) {
							...
							android.widget.Toast.makeText(MainActivity, "Credit: Firepro9978 from VoidClient!", 1)
								.show();
	...
	MainActivity.runOnUiThread(new java.lang.Runnable({
		run: function () {
			try {
				...
				info = new android.widget.PopupWindow(infoLayout1, MainActivity.getWindowManager()
					.getDefaultDisplay()
				...
				info.showAtLocation(MainActivity.getWindow()
	...
	MainActivity.runOnUiThread(new java.lang.Runnable({
		run: function () {
			try {
				...
				if (getLanguage == "zh_CN") cheats.setText("在线菜单");
								...
								liquidhack.setOnClickListener(new android.view.View.OnClickListener({
									onClick: function (viewarg) {
										...
										if (liquidwalk == true) {
											...
											android.widget.Toast.makeText(MainActivity, "Credit: GodSoft029!", 1)
												.show();
								...
								button8.setOnClickListener(new android.view.View.OnClickListener({
									onClick: function (viewarg) {
										...
										if (block == true) {
											...
											android.widget.Toast.makeText(MainActivity, "Credit: Johnmacrocraft!", 1)
												.show();
											block = true;
										}
										if (block == false) {
								...
								button11.setOnClickListener(new android.view.View.OnClickListener({
									onClick: function (viewarg) {
										...
										if (chestesp == true) {
											...
											android.widget.Toast.makeText(MainActivity, "Credit: Vertex Client team!", 1)
												.show();
											chestesp = true;
										}
										if (chestesp == false) {
								...
								taura.setOnClickListener(new android.view.View.OnClickListener({
									onClick: function (viewarg) {
										...
										if (tpAura == true) {
											...
											clientMessage(client + "TP Aura on");
											android.widget.Toast.makeText(MainActivity, "Credit: Apric0cks for the idea!", 1)
												.show();
											tpAura = true;
										}
										if (tpAura == false) {
								...
								*
								...
								info.setOnClickListener(new android.view.View.OnClickListener({
									onClick: function (viewarg) {
										infoView();
										cheat.dismiss();
										android.widget.Toast.makeText(MainActivity, "Scroll down", 1)
											.show();
									}
								}));
									...
									MainActivity.runOnUiThread(new java.lang.Runnable({
										run: function () {
											try {
												...
												cmd1.setOnClickListener(new android.view.View.OnClickListener() {
													onClick: function (v) {
														if (Server.getPort() != 0) {
															...
															android.widget.Toast.makeText(MainActivity, "Command has been sent.", 1)
																.show();
														}
														if (Server.getPort() == 0) {
												...
												cmd = new android.widget.PopupWindow(cmdLayout1, MainActivity.getWindowManager()
													.getDefaultDisplay()
													.getWidth() / GUISize, MainActivity.getWindowManager()
													.getDefaultDisplay()
													.getHeight());
												...
												cmd.showAtLocation(MainActivity.getWindow()
													.getDecorView(), GUIPos | android.view.Gravity.TOP, 0, 0);
											} catch (error) {
												android.widget.Toast.makeText(MainActivity, "Error! : " + error, 1)
													.show();
									...
									MainActivity.runOnUiThread(new java.lang.Runnable({
										run: function () {
											try {
												...
												XYZ = new android.widget.PopupWindow(XYZLayout1, MainActivity.getWindowManager()
													.getDefaultDisplay()
													.getWidth() / 2, MainActivity.getWindowManager()
													.getDefaultDisplay()
													.getHeight() / 1);
												...
												XYZ.showAtLocation(MainActivity.getWindow()
													.getDecorView(), android.view.Gravity.CENTER | android.view.Gravity.TOP, 0, 0);
											} catch (error) {
												android.widget.Toast.makeText(MainActivity, "Error! : " + error, 1)
													.show();
...
fasteat = false;
	    ...
	    */
								...
								*
								...
								cheat = new android.widget.PopupWindow(cheatLayout1, MainActivity.getWindowManager()
									.getDefaultDisplay()
									.getWidth() / GUISize, MainActivity.getWindowManager()
									.getDefaultDisplay()
									.getHeight());
								...
								cheat.showAtLocation(MainActivity.getWindow()
									.getDecorView(), GUIPos | android.view.Gravity.TOP, 0, 0);
							} catch (error) {
								android.widget.Toast.makeText(MainActivity, "Error! : " + error, 1)
									.show();
				...
				if (getLanguage == "zh_CN") mods.setText("离线菜单");
							...
							try {
								...
								button14.setOnClickListener(new android.view.View.OnClickListener({
									onClick: function (viewarg) {
										...
										Level.setTile(getPlayerX() - 3, getPlayerY() - 1, getPlayerZ() - 8, 60, 0);
										//crops
										Level.setTile(getPlayerX(), getPlayerY(), getPlayerZ() - 4, 59, 0);
										Level.setTile(getPlayerX() + 1, getPlayerY(), getPlayerZ() - 4, 59, 0);
										Level.setTile(getPlayerX() - 1, getPlayerY(), getPlayerZ() - 4, 59, 0);
										Level.setTile(getPlayerX() + 2, getPlayerY(), getPlayerZ() - 4, 59, 0);
										Level.setTile(getPlayerX() - 2, getPlayerY(), getPlayerZ() - 4, 59, 0);
										Level.setTile(getPlayerX() + 3, getPlayerY(), getPlayerZ() - 4, 59, 0);
										Level.setTile(getPlayerX() - 3, getPlayerY(), getPlayerZ() - 4, 59, 0);
										Level.setTile(getPlayerX(), getPlayerY(), getPlayerZ() - 5, 59, 0);
										Level.setTile(getPlayerX() + 1, getPlayerY(), getPlayerZ() - 5, 59, 0);
										Level.setTile(getPlayerX() - 1, getPlayerY(), getPlayerZ() - 5, 59, 0);
										Level.setTile(getPlayerX() + 2, getPlayerY(), getPlayerZ() - 5, 59, 0);
										Level.setTile(getPlayerX() - 2, getPlayerY(), getPlayerZ() - 5, 59, 0);
										Level.setTile(getPlayerX() + 3, getPlayerY(), getPlayerZ() - 5, 59, 0);
										Level.setTile(getPlayerX() - 3, getPlayerY(), getPlayerZ() - 5, 59, 0);
...
getage = false;
		...
		*/
								...
								mod = new android.widget.PopupWindow(modLayout1, MainActivity.getWindowManager()
									.getDefaultDisplay()
									.getWidth() / GUISize, MainActivity.getWindowManager()
									.getDefaultDisplay()
									.getHeight());
								...
								mod.showAtLocation(MainActivity.getWindow()
									.getDecorView(), GUIPos | android.view.Gravity.TOP, 0, 0);
							} catch (error) {
								android.widget.Toast.makeText(MainActivity, "Error! : " + error, 1)
									.show();
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				new10.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				spaD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				digg.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				netherD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				entD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				diffD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				nameeD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
				print("name dialog:" + e);
			}
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				lightD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				resisD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				healthD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				heartD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				ageD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
				print("age dialog:" + e);
			}
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				act1.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				act2.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	ctx.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				signD.showAtLocation(ctx.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
				print("sign dialog:" + e);
			}
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				fovD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
				print("fov dialog:" + e);
			}
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				sendD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
			...
			try {
				...
				Exit.setOnClickListener(new android.view.View.OnClickListener() {
					onClick: function (view) {
						...
						android.widget.Toast.makeText(MainActivity, "Set to: " + rang, 1)
							.show();
						Dialog.dismiss();
					}
				});
				...
				rangeD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				Exit.setOnClickListener(new android.view.View.OnClickListener() {
					onClick: function (view) {
						if (height <= 10) {
							...
							android.widget.Toast.makeText(MainActivity, "Set to: " + height, 1)
								.show();
						}
						if (height >= 10) {
							jumpheight = 9;
							android.widget.Toast.makeText(MainActivity, "Set to default: " + jumpheight, 1)
								.show();
						}
						Dialog.dismiss();
					}
				...
				heightD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				shadowD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
	...
	MainActivity.runOnUiThread(new java.lang.Runnable() {
		run: function () {
			try {
				...
				nitemD.showAtLocation(MainActivity.getWindow()
					.getDecorView(), android.view.Gravity.TOP, 0, 0);
			} catch (e) {
...
function devpardon() {
	var file = new java.io.File(android.os.Environment.getExternalStorageDirectory()
		.getAbsolutePath() + "/games/com.mojang/minecraftpe/clientId.txt/");
	var path = android.os.Environment.getExternalStorageDirectory()
		.getAbsolutePath() + "/games/com.mojang/minecraftpe/clientId.txt/";
	java.io.File(path)
		.mkdirs();
	file.delete();
	android.widget.Toast.makeText(ctx, "Restart Minecraft PE", 1)
		.show();
}
...
function hashBroadcast(text) {
	...
	var normal = new Array("a", "b", "e", "h", "i", "j", "k", "l", "m", "o", "p", "q", "s", "t", "v", "w", "x", "y", "z");
...
function unhashBroadcast(text) {
	...
	var algorithm = new Array("a", "b", "e", "h", "i", "j", "k", "l", "m", "o", "p", "q", "s", "t", "v", "w", "x", "y", "z");
	for (i = 0; i < normal.length; i++) {
